...
@NoArgsConstructor
@Log4j
public class LargeTire implements ITire {
   ...
   public int roll(int distance) {
      ...
      log.info(ITire.LARGE_INCH + "인치 타이어로 자전거가 굴러갑니다.");

      tireLife = ITire.LARGE_INCH_TIRE_LIFE;

      while (this.tireLife > 0) {
         distance = distance - 7; // 한번 주행시 7km, 타이어 수명 -1
         tireLife--;
